...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Jadwal Konsultasi Baru</title>
	</head>
	<body>
		<div>
												...
												<tr>
													<td style="padding:17px 3.358% 15px">
														<cite style="text-align:center;display:block;font-style:normal">
															<span style="font-size:1px;min-height:0;color:#fff;width:0;display:block">Pemberitahuan Konsultasi KPPN Sujunjung.</span>
																		...
																		<td align="left">
																			<div style="width:100%">
																				...
																				<table border="0">
																					...
																					<tr>
																						<td> <?php echo $data["open_message"]; ?>  </td>
																					</tr>
